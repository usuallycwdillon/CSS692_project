#################################################################################
# This is R script that I can't stand to part with but it doesn't do anything 
# useful; produces useless info or fails to produce anything more than errors.
# To paraphrase, 'perhaps the purpose of this code is merely to serve as a 
# warning to others. ~CWDillon
#################################################################################
library("igraph")
...
# This should be faster under snow, mc
repo_copy <- repo_meta
